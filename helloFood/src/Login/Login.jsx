  ...
  return (
    <>
      <div className="hero min-h-screen w-full bg-base-200">
        <div className="hero-content flex-col w-10/12 lg:flex-row-reverse">
          ...
          <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
            ...
            <p className="text-center">Don`t have an account? <Link to={'/signup'} className=" underline hover:text-blue-400">SignUp Now!</Link></p>
            ...
            <div className="my-4 flex justify-center">
              <button type="button" onClick={signwithgoogle} className="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm sm:p-4 dark:bg-slate-900 dark:hover:bg-slate-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800">
